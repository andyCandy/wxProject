...
/**
 * <p>FloatingTerminationPointType complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="FloatingTerminationPointType">
 *   &lt;complexContent>
...
@XmlType(name = "FloatingTerminationPointType", propOrder = {
    "direction",
...
public class FloatingTerminationPointType
