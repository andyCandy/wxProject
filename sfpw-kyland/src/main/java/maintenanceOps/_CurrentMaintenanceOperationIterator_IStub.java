...
public class _CurrentMaintenanceOperationIterator_IStub
	...
	implements maintenanceOps.CurrentMaintenanceOperationIterator_I
{
	...
	public final static java.lang.Class _opsClass = maintenanceOps.CurrentMaintenanceOperationIterator_IOperations.class;
	...
	public boolean next_n(int how_many, maintenanceOps.CurrentMaintenanceOperationList_THolder cMOList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				cMOList.value = maintenanceOps.CurrentMaintenanceOperationList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
