...
/**
 *	Generated from IDL definition of alias "PropertyValue"
...
public final class PropertyValueHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CosTrading.PropertyValueHelper.id(), "PropertyValue",org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(11)));
		}
		return _type;
	}
	...
	{
		return "IDL:omg.org/CosTrading/PropertyValue:1.0";
	}
