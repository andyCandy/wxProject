	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public static final int _tk_component = 34;
	public static final TCKind tk_component = new TCKind(_tk_component);
	public static final int _tk_home = 35;
	public static final TCKind tk_home = new TCKind(_tk_home);
	public int value()
	{
		return value;
	}
	public static TCKind from_int(int value)
	{
		switch (value) {
			...
			case _tk_local_interface: return tk_local_interface;
			case _tk_component: return tk_component;
			case _tk_home: return tk_home;
