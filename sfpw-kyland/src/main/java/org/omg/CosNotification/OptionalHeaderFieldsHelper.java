...
public final class OptionalHeaderFieldsHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CosNotification.OptionalHeaderFieldsHelper.id(), "OptionalHeaderFields",org.omg.CosNotification.PropertySeqHelper.type());
		}
		return _type;
	}
	...
	{
		return "IDL:omg.org/CosNotification/OptionalHeaderFields:1.0";
	}
