...
public final class QoSPropertiesHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.CosNotification.QoSPropertiesHelper.id(), "QoSProperties",org.omg.CosNotification.PropertySeqHelper.type());
		}
		return _type;
	}
