...
public class _TopoMgr_IStub
	...
	implements TopoManagementManager.TopoMgr_I
{
	...
	public final static java.lang.Class _opsClass = TopoManagementManager.TopoMgr_IOperations.class;
	...
	public void getTopoSubnetworkViewInfo(int how_many, TopoManagementManager.NodeList_THolder nodeList, TopoManagementManager.NodeIterator_IHolder NodeIt) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				nodeList.value = TopoManagementManager.NodeList_THelper.read(_is);
				NodeIt.value = TopoManagementManager.NodeIterator_IHelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
