...
public final class TopologicalLinkIterator_IHelper
{
	...
	public static topologicalLink.TopologicalLinkIterator_I narrow(final java.lang.Object obj)
	{
		if (obj instanceof topologicalLink.TopologicalLinkIterator_I)
		{
	...
	public static topologicalLink.TopologicalLinkIterator_I narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:mtnm.tmforum.org/topologicalLink/TopologicalLinkIterator_I:1.0"))
			{
