	...
	implements org.omg.CORBA.portable.InvokeHandler, guiCutThrough.GuiCutThroughMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "launchGCT", new java.lang.Integer(2));
		m_opsHash.put ( "setUserLabel", new java.lang.Integer(3));
		m_opsHash.put ( "destroyGCT", new java.lang.Integer(4));
		m_opsHash.put ( "getGCTProfileInfo", new java.lang.Integer(5));
