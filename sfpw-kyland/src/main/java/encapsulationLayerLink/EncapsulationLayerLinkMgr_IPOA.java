	...
	implements org.omg.CORBA.portable.InvokeHandler, encapsulationLayerLink.EncapsulationLayerLinkMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getAllELLinksWithMeOrFd", new java.lang.Integer(5));
		m_opsHash.put ( "createELLink", new java.lang.Integer(6));
		m_opsHash.put ( "getAllELLinkNames", new java.lang.Integer(7));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(8));
		m_opsHash.put ( "getELLinkWithTP", new java.lang.Integer(9));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(10));
		m_opsHash.put ( "decreaseBandwidthOfELLink", new java.lang.Integer(11));
		m_opsHash.put ( "increaseBandwidthOfELLink", new java.lang.Integer(12));
		m_opsHash.put ( "setELLinkLCASState", new java.lang.Integer(13));
		m_opsHash.put ( "activateELLink", new java.lang.Integer(14));
		m_opsHash.put ( "deactivateELLink", new java.lang.Integer(15));
		m_opsHash.put ( "getAllELLinks", new java.lang.Integer(16));
		m_opsHash.put ( "getELLinkWithSncOrTl", new java.lang.Integer(17));
		m_opsHash.put ( "getELLink", new java.lang.Integer(18));
		m_opsHash.put ( "getServerSNCsAndTLs", new java.lang.Integer(19));
		m_opsHash.put ( "modifyELLink", new java.lang.Integer(20));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // getAllELLinksWithMeOrFd
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 11: // decreaseBandwidthOfELLink
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 12: // increaseBandwidthOfELLink
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
