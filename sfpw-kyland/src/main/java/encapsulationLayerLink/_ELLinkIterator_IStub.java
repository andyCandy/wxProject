...
public class _ELLinkIterator_IStub
	...
	implements encapsulationLayerLink.ELLinkIterator_I
{
	...
	public final static java.lang.Class _opsClass = encapsulationLayerLink.ELLinkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, encapsulationLayerLink.ELLinkList_THolder ellList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				ellList.value = encapsulationLayerLink.ELLinkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
