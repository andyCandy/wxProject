...
public class _OfferIdIteratorStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosTrading.OfferIdIterator
{
	...
	public final static java.lang.Class _opsClass = CosTrading.OfferIdIteratorOperations.class;
	public boolean next_n(int n, org.omg.CosTrading.OfferIdSeqHolder ids)
	{
		...
		else
		{
			...
			OfferIdIteratorOperations _localServant = (OfferIdIteratorOperations)_so.servant;
			boolean _result;			try
			{
			_result = _localServant.next_n(n,ids);
			}
			finally
			{
