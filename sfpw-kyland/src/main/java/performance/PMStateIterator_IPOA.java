...
public abstract class PMStateIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, performance.PMStateIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				performance.PMStateList_THolder _arg1= new performance.PMStateList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				performance.PMStateList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
