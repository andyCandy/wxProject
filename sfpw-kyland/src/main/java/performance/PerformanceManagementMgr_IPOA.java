	...
	implements org.omg.CORBA.portable.InvokeHandler, performance.PerformanceManagementMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "createPMCollectionTask", new java.lang.Integer(7));
		m_opsHash.put ( "getPMState", new java.lang.Integer(8));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(9));
		m_opsHash.put ( "disableTCA", new java.lang.Integer(10));
		m_opsHash.put ( "enableTCA", new java.lang.Integer(11));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(12));
		m_opsHash.put ( "getHistoryPMData", new java.lang.Integer(13));
		m_opsHash.put ( "setTCATPParameter", new java.lang.Integer(14));
		m_opsHash.put ( "disablePMData", new java.lang.Integer(15));
		m_opsHash.put ( "getTCATPParameter", new java.lang.Integer(16));
		m_opsHash.put ( "clearPMData", new java.lang.Integer(17));
		m_opsHash.put ( "deletePMCollectionTask", new java.lang.Integer(18));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 18: // deletePMCollectionTask
			{
			try
			{
				java.lang.String[] _arg0=performance.CollectTaskNameList_THelper.read(_input);
