...
public abstract class ProxyPushSupplierPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.ProxyPushSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "resume_connection", new java.lang.Integer(8));
		m_opsHash.put ( "disconnect_push_supplier", new java.lang.Integer(9));
		m_opsHash.put ( "connect_any_push_consumer", new java.lang.Integer(10));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 9: // disconnect_push_supplier
			{
				_out = handler.createReply();
				disconnect_push_supplier();
				break;
			}
			case 10: // connect_any_push_consumer
			{
			try
			{
