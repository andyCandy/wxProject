...
public class _ProxyPullConsumerStub
	...
	implements org.omg.CosNotifyChannelAdmin.ProxyPullConsumer
{
	private String[] ids = {"IDL:omg.org/CosNotifyChannelAdmin/ProxyPullConsumer:1.0","IDL:omg.org/CosNotifyComm/PullConsumer:1.0","IDL:omg.org/CosNotifyComm/NotifyPublish:1.0","IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0","IDL:omg.org/CosEventComm/PullConsumer:1.0","IDL:omg.org/CosNotification/QoSAdmin:1.0","IDL:omg.org/CosNotifyChannelAdmin/ProxyConsumer:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.ProxyPullConsumerOperations.class;
	...
	public void connect_any_pull_supplier(org.omg.CosEventComm.PullSupplier pull_supplier) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_any_pull_supplier", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_any_pull_supplier", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ProxyPullConsumerOperations _localServant = (ProxyPullConsumerOperations)_so.servant;
			try
			{
			_localServant.connect_any_pull_supplier(pull_supplier);
			}
			finally
			{
				_servant_postinvoke(_so);
