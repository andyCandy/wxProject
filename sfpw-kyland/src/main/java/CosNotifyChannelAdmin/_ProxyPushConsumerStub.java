...
public class _ProxyPushConsumerStub
	...
	implements org.omg.CosNotifyChannelAdmin.ProxyPushConsumer
{
	private String[] ids = {"IDL:omg.org/CosNotifyChannelAdmin/ProxyPushConsumer:1.0","IDL:omg.org/CosEventComm/PushConsumer:1.0","IDL:omg.org/CosNotifyComm/PushConsumer:1.0","IDL:omg.org/CosNotifyComm/NotifyPublish:1.0","IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0","IDL:omg.org/CosNotification/QoSAdmin:1.0","IDL:omg.org/CosNotifyChannelAdmin/ProxyConsumer:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.ProxyPushConsumerOperations.class;
	...
	public void connect_any_push_supplier(org.omg.CosEventComm.PushSupplier push_supplier) throws org.omg.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_any_push_supplier", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_any_push_supplier", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ProxyPushConsumerOperations _localServant = (ProxyPushConsumerOperations)_so.servant;
			try
			{
			_localServant.connect_any_push_supplier(push_supplier);
			}
			finally
			{
				_servant_postinvoke(_so);
