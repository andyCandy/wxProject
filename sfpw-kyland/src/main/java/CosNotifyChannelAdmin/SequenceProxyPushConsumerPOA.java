...
public abstract class SequenceProxyPushConsumerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "disconnect_sequence_push_consumer", new java.lang.Integer(2));
		m_opsHash.put ( "validate_event_qos", new java.lang.Integer(3));
		m_opsHash.put ( "connect_sequence_push_supplier", new java.lang.Integer(4));
		...
		m_opsHash.put ( "push_structured_events", new java.lang.Integer(9));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 2: // disconnect_sequence_push_consumer
			{
				_out = handler.createReply();
			...
			case 4: // connect_sequence_push_supplier
			{
			try
			{
				org.omg.CosNotifyComm.SequencePushSupplier _arg0=org.omg.CosNotifyComm.SequencePushSupplierHelper.read(_input);
				_out = handler.createReply();
				connect_sequence_push_supplier(_arg0);
			}
