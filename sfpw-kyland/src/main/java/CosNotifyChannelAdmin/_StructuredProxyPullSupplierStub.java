...
public class _StructuredProxyPullSupplierStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplier
{
	private String[] ids = {"IDL:omg.org/CosNotifyChannelAdmin/StructuredProxyPullSupplier:1.0","IDL:omg.org/CosNotifyChannelAdmin/ProxySupplier:1.0","IDL:omg.org/CosNotifyComm/NotifySubscribe:1.0","IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0","IDL:omg.org/CosNotifyComm/StructuredPullSupplier:1.0","IDL:omg.org/CosNotification/QoSAdmin:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.StructuredProxyPullSupplierOperations.class;
	public int[] get_all_filters()
	{
		...
		else
		{
			...
			StructuredProxyPullSupplierOperations _localServant = (StructuredProxyPullSupplierOperations)_so.servant;
			int[] _result;			try
			{
	...
	public org.omg.CosNotification.StructuredEvent pull_structured_event() throws org.omg.CosEventComm.Disconnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "pull_structured_event", true);
				_is = _invoke(_os);
				org.omg.CosNotification.StructuredEvent _result = org.omg.CosNotification.StructuredEventHelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "pull_structured_event", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			StructuredProxyPullSupplierOperations _localServant = (StructuredProxyPullSupplierOperations)_so.servant;
			org.omg.CosNotification.StructuredEvent _result;			try
			{
			_result = _localServant.pull_structured_event();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void disconnect_structured_pull_supplier()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "disconnect_structured_pull_supplier", true);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "disconnect_structured_pull_supplier", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			StructuredProxyPullSupplierOperations _localServant = (StructuredProxyPullSupplierOperations)_so.servant;
			try
			{
			_localServant.disconnect_structured_pull_supplier();
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void connect_structured_pull_consumer(org.omg.CosNotifyComm.StructuredPullConsumer pull_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_structured_pull_consumer", true);
				org.omg.CosNotifyComm.StructuredPullConsumerHelper.write(_os,pull_consumer);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_structured_pull_consumer", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			StructuredProxyPullSupplierOperations _localServant = (StructuredProxyPullSupplierOperations)_so.servant;
			try
			{
			_localServant.connect_structured_pull_consumer(pull_consumer);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public org.omg.CosNotification.StructuredEvent try_pull_structured_event(org.omg.CORBA.BooleanHolder has_event) throws org.omg.CosEventComm.Disconnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "try_pull_structured_event", true);
				_is = _invoke(_os);
				org.omg.CosNotification.StructuredEvent _result = org.omg.CosNotification.StructuredEventHelper.read(_is);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "try_pull_structured_event", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			StructuredProxyPullSupplierOperations _localServant = (StructuredProxyPullSupplierOperations)_so.servant;
			org.omg.CosNotification.StructuredEvent _result;			try
			{
			_result = _localServant.try_pull_structured_event(has_event);
			}
			finally
			{
				_servant_postinvoke(_so);
