	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "disconnect_structured_push_supplier", new java.lang.Integer(6));
		m_opsHash.put ( "get_filter", new java.lang.Integer(7));
		m_opsHash.put ( "set_qos", new java.lang.Integer(8));
		m_opsHash.put ( "resume_connection", new java.lang.Integer(9));
		...
		m_opsHash.put ( "connect_structured_push_consumer", new java.lang.Integer(17));
