...
public class _StructuredProxyPushConsumerStub
	...
	implements org.omg.CosNotifyChannelAdmin.StructuredProxyPushConsumer
{
	...
	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations.class;
	public void connect_structured_push_supplier(org.omg.CosNotifyComm.StructuredPushSupplier push_supplier) throws org.omg.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_structured_push_supplier", true);
				org.omg.CosNotifyComm.StructuredPushSupplierHelper.write(_os,push_supplier);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_structured_push_supplier", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			StructuredProxyPushConsumerOperations _localServant = (StructuredProxyPushConsumerOperations)_so.servant;
			try
			{
			_localServant.connect_structured_push_supplier(push_supplier);
			}
			finally
			{
