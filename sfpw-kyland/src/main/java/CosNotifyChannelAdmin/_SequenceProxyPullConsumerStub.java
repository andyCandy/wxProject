...
public class _SequenceProxyPullConsumerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdmin.SequenceProxyPullConsumer
{
	...
	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.SequenceProxyPullConsumerOperations.class;
	public void connect_sequence_pull_supplier(org.omg.CosNotifyComm.SequencePullSupplier pull_supplier) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_sequence_pull_supplier", true);
				org.omg.CosNotifyComm.SequencePullSupplierHelper.write(_os,pull_supplier);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_sequence_pull_supplier", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			SequenceProxyPullConsumerOperations _localServant = (SequenceProxyPullConsumerOperations)_so.servant;
			try
			{
			_localServant.connect_sequence_pull_supplier(pull_supplier);
			}
			finally
			{
	...
	public void disconnect_sequence_pull_consumer()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "disconnect_sequence_pull_consumer", true);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "disconnect_sequence_pull_consumer", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			SequenceProxyPullConsumerOperations _localServant = (SequenceProxyPullConsumerOperations)_so.servant;
			try
			{
			_localServant.disconnect_sequence_pull_consumer();
			}
			finally
			{
				_servant_postinvoke(_so);
