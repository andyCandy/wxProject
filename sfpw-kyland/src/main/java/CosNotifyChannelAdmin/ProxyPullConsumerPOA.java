...
public abstract class ProxyPullConsumerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.ProxyPullConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "connect_any_pull_supplier", new java.lang.Integer(2));
		...
		m_opsHash.put ( "disconnect_pull_consumer", new java.lang.Integer(8));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // disconnect_pull_consumer
			{
				_out = handler.createReply();
