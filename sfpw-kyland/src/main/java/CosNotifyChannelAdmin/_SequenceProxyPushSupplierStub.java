...
public class _SequenceProxyPushSupplierStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdmin.SequenceProxyPushSupplier
{
	...
	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations.class;
	public int[] get_all_filters()
	{
		...
		else
		{
			...
			SequenceProxyPushSupplierOperations _localServant = (SequenceProxyPushSupplierOperations)_so.servant;
			int[] _result;			try
			{
	...
	public void connect_sequence_push_consumer(org.omg.CosNotifyComm.SequencePushConsumer push_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_sequence_push_consumer", true);
				org.omg.CosNotifyComm.SequencePushConsumerHelper.write(_os,push_consumer);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_sequence_push_consumer", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			SequenceProxyPushSupplierOperations _localServant = (SequenceProxyPushSupplierOperations)_so.servant;
			try
			{
			_localServant.connect_sequence_push_consumer(push_consumer);
			}
			finally
			{
				_servant_postinvoke(_so);
