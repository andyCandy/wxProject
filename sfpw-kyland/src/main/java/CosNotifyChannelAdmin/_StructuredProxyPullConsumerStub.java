...
public class _StructuredProxyPullConsumerStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdmin.StructuredProxyPullConsumer
{
	...
	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.StructuredProxyPullConsumerOperations.class;
	public org.omg.CosNotifyChannelAdmin.ProxyType MyType()
	{
		...
		if( _so == null )
			...
			StructuredProxyPullConsumerOperations _localServant = (StructuredProxyPullConsumerOperations)_so.servant;
	...
	public void connect_structured_pull_supplier(org.omg.CosNotifyComm.StructuredPullSupplier pull_supplier) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_structured_pull_supplier", true);
				org.omg.CosNotifyComm.StructuredPullSupplierHelper.write(_os,pull_supplier);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_structured_pull_supplier", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			StructuredProxyPullConsumerOperations _localServant = (StructuredProxyPullConsumerOperations)_so.servant;
			try
			{
			_localServant.connect_structured_pull_supplier(pull_supplier);
			}
			finally
			{
				_servant_postinvoke(_so);
