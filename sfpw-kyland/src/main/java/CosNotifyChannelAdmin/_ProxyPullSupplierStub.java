...
public class _ProxyPullSupplierStub
	...
	implements org.omg.CosNotifyChannelAdmin.ProxyPullSupplier
{
	private String[] ids = {"IDL:omg.org/CosNotifyChannelAdmin/ProxyPullSupplier:1.0","IDL:omg.org/CosNotifyComm/PullSupplier:1.0","IDL:omg.org/CosNotifyChannelAdmin/ProxySupplier:1.0","IDL:omg.org/CosNotifyComm/NotifySubscribe:1.0","IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0","IDL:omg.org/CosEventComm/PullSupplier:1.0","IDL:omg.org/CosNotification/QoSAdmin:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.ProxyPullSupplierOperations.class;
	...
	public void connect_any_pull_consumer(org.omg.CosEventComm.PullConsumer pull_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_any_pull_consumer", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connect_any_pull_consumer", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ProxyPullSupplierOperations _localServant = (ProxyPullSupplierOperations)_so.servant;
			try
			{
			_localServant.connect_any_pull_consumer(pull_consumer);
			}
			finally
			{
				_servant_postinvoke(_so);
