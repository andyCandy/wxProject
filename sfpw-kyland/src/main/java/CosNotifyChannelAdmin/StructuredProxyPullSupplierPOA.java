...
public abstract class StructuredProxyPullSupplierPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.StructuredProxyPullSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "pull_structured_event", new java.lang.Integer(4));
		m_opsHash.put ( "disconnect_structured_pull_supplier", new java.lang.Integer(5));
		m_opsHash.put ( "_get_priority_filter", new java.lang.Integer(6));
		m_opsHash.put ( "get_filter", new java.lang.Integer(7));
		m_opsHash.put ( "connect_structured_pull_consumer", new java.lang.Integer(8));
		m_opsHash.put ( "set_qos", new java.lang.Integer(9));
		m_opsHash.put ( "obtain_offered_types", new java.lang.Integer(10));
		m_opsHash.put ( "add_filter", new java.lang.Integer(11));
		m_opsHash.put ( "subscription_change", new java.lang.Integer(12));
		m_opsHash.put ( "_set_priority_filter", new java.lang.Integer(13));
		m_opsHash.put ( "validate_event_qos", new java.lang.Integer(14));
		m_opsHash.put ( "remove_filter", new java.lang.Integer(15));
		...
		m_opsHash.put ( "try_pull_structured_event", new java.lang.Integer(19));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // disconnect_structured_pull_supplier
			{
				_out = handler.createReply();
			...
			case 19: // try_pull_structured_event
			{
			try
			{
