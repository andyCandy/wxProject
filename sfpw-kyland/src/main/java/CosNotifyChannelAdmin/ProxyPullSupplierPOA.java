...
public abstract class ProxyPullSupplierPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyChannelAdmin.ProxyPullSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_get_MyType", new java.lang.Integer(5));
		...
		m_opsHash.put ( "pull", new java.lang.Integer(9));
		m_opsHash.put ( "connect_any_pull_consumer", new java.lang.Integer(10));
