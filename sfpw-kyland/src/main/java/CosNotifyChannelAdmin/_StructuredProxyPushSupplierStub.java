...
public class _StructuredProxyPushSupplierStub
	...
	implements org.omg.CosNotifyChannelAdmin.StructuredProxyPushSupplier
{
	...
	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations.class;
	...
	public void connect_structured_push_consumer(org.omg.CosNotifyComm.StructuredPushConsumer push_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected,org.omg.CosEventChannelAdmin.TypeError
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.CosNotifyComm.StructuredPushConsumerHelper.write(_os,push_consumer);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
