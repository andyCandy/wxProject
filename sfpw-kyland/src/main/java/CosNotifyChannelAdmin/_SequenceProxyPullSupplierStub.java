...
public class _SequenceProxyPullSupplierStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements org.omg.CosNotifyChannelAdmin.SequenceProxyPullSupplier
{
	...
	public final static java.lang.Class _opsClass = CosNotifyChannelAdmin.SequenceProxyPullSupplierOperations.class;
	public int[] get_all_filters()
	{
		...
		else
		{
			...
			SequenceProxyPullSupplierOperations _localServant = (SequenceProxyPullSupplierOperations)_so.servant;
			int[] _result;			try
			{
	...
	public void connect_sequence_pull_consumer(org.omg.CosNotifyComm.SequencePullConsumer pull_consumer) throws org.omg.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "connect_sequence_pull_consumer", true);
	...
	public org.omg.CosNotification.StructuredEvent[] pull_structured_events(int max_number) throws org.omg.CosEventComm.Disconnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "pull_structured_events", true);
	...
	public void disconnect_sequence_pull_supplier()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "disconnect_sequence_pull_supplier", true);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
	...
	public org.omg.CosNotification.StructuredEvent[] try_pull_structured_events(int max_number, org.omg.CORBA.BooleanHolder has_event) throws org.omg.CosEventComm.Disconnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "try_pull_structured_events", true);
				_os.write_long(max_number);
				_is = _invoke(_os);
				org.omg.CosNotification.StructuredEvent[] _result = org.omg.CosNotification.EventBatchHelper.read(_is);
