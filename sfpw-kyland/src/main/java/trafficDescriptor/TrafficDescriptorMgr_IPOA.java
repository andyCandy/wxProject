	...
	implements org.omg.CORBA.portable.InvokeHandler, trafficDescriptor.TrafficDescriptorMgr_IOperations
{
	...
	static
	{
		m_opsHash.put ( "getTrafficDescriptor", new java.lang.Integer(0));
		m_opsHash.put ( "getAllTrafficDescriptors", new java.lang.Integer(1));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(2));
		m_opsHash.put ( "activateTrafficDescriptor", new java.lang.Integer(3));
		m_opsHash.put ( "HW_getAllTrafficDescriptorNames", new java.lang.Integer(4));
		m_opsHash.put ( "deactivateTrafficDescriptor", new java.lang.Integer(5));
		m_opsHash.put ( "HW_getAllTrafficDescriptors", new java.lang.Integer(6));
		m_opsHash.put ( "deleteTrafficDescriptor", new java.lang.Integer(7));
		m_opsHash.put ( "HW_createTrafficDescriptor", new java.lang.Integer(8));
		m_opsHash.put ( "createTrafficDescriptor", new java.lang.Integer(9));
		m_opsHash.put ( "setUserLabel", new java.lang.Integer(10));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(11));
		m_opsHash.put ( "getAssociatedCTPs", new java.lang.Integer(12));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 1: // getAllTrafficDescriptors
			{
			try
			{
			...
			case 3: // activateTrafficDescriptor
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 4: // HW_getAllTrafficDescriptorNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 5: // deactivateTrafficDescriptor
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 6: // HW_getAllTrafficDescriptors
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 7: // deleteTrafficDescriptor
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 8: // HW_createTrafficDescriptor
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 9: // createTrafficDescriptor
			{
			try
			{
