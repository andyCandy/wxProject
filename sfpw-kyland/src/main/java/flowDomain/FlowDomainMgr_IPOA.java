	...
	implements org.omg.CORBA.portable.InvokeHandler, flowDomain.FlowDomainMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "removeFPsFromFDFr", new java.lang.Integer(11));
		m_opsHash.put ( "getAssigningMFD", new java.lang.Integer(12));
		m_opsHash.put ( "getAllFlowDomains", new java.lang.Integer(13));
		m_opsHash.put ( "getAllCPTPs", new java.lang.Integer(14));
		m_opsHash.put ( "getFDfromMFD", new java.lang.Integer(15));
		m_opsHash.put ( "createFTP", new java.lang.Integer(16));
		m_opsHash.put ( "getAllFDFrs", new java.lang.Integer(17));
		m_opsHash.put ( "getFDFrsWithTP", new java.lang.Integer(18));
		m_opsHash.put ( "createFlowDomain", new java.lang.Integer(19));
		m_opsHash.put ( "setUserLabel", new java.lang.Integer(20));
		m_opsHash.put ( "modifyFDFr", new java.lang.Integer(21));
		m_opsHash.put ( "getFDFrServerTrail", new java.lang.Integer(22));
		m_opsHash.put ( "getMFD", new java.lang.Integer(23));
		m_opsHash.put ( "assignCPTPsToMFD", new java.lang.Integer(24));
		m_opsHash.put ( "modifyMFD", new java.lang.Integer(25));
		m_opsHash.put ( "getAllMFDNames", new java.lang.Integer(26));
		m_opsHash.put ( "getFDFrsByUserLabel", new java.lang.Integer(27));
		m_opsHash.put ( "performEthernetOAMCommand", new java.lang.Integer(28));
		m_opsHash.put ( "getTransmissionParams", new java.lang.Integer(29));
		m_opsHash.put ( "associateMFDsWithFlowDomain", new java.lang.Integer(30));
		m_opsHash.put ( "deAssociateMFDsFromFlowDomain", new java.lang.Integer(31));
		m_opsHash.put ( "getFDFr", new java.lang.Integer(32));
		m_opsHash.put ( "createFDFr", new java.lang.Integer(33));
		m_opsHash.put ( "addFPsToFDFr", new java.lang.Integer(34));
		m_opsHash.put ( "deactivateFDFr", new java.lang.Integer(35));
		m_opsHash.put ( "associateCPTPsWithFlowDomain", new java.lang.Integer(36));
		m_opsHash.put ( "getFlowDomainsByUserLabel", new java.lang.Integer(37));
		m_opsHash.put ( "activateFDFr", new java.lang.Integer(38));
		m_opsHash.put ( "deleteFTP", new java.lang.Integer(39));
		m_opsHash.put ( "deleteFlowDomain", new java.lang.Integer(40));
		m_opsHash.put ( "unassignCPTPsFromMFD", new java.lang.Integer(41));
		m_opsHash.put ( "deAssociateCPTPsFromFlowDomain", new java.lang.Integer(42));
		m_opsHash.put ( "modifyFlowDomain", new java.lang.Integer(43));
		m_opsHash.put ( "getAllEthernetOAMPoint", new java.lang.Integer(44));
		m_opsHash.put ( "getFlowDomain", new java.lang.Integer(45));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 28: // performEthernetOAMCommand
			{
			try
			{
			...
			case 30: // associateMFDsWithFlowDomain
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 31: // deAssociateMFDsFromFlowDomain
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 36: // associateCPTPsWithFlowDomain
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 37: // getFlowDomainsByUserLabel
			{
			try
			{
				java.lang.String _arg0=_input.read_string();
			...
			case 42: // deAssociateCPTPsFromFlowDomain
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 44: // getAllEthernetOAMPoint
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
