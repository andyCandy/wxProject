...
public class _FDIterator_IStub
	...
	implements flowDomain.FDIterator_I
{
	...
	public final static java.lang.Class _opsClass = flowDomain.FDIterator_IOperations.class;
	...
	public boolean next_n(int how_many, flowDomain.FDList_THolder fdList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				fdList.value = flowDomain.FDList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
