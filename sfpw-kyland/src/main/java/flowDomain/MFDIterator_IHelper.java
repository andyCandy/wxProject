...
public final class MFDIterator_IHelper
{
	...
	public static flowDomain.MFDIterator_I narrow(final java.lang.Object obj)
	{
		if (obj instanceof flowDomain.MFDIterator_I)
		{
	...
	public static flowDomain.MFDIterator_I unchecked_narrow(final org.omg.CORBA.Object obj)
	{
		if (obj == null)
			return null;
		try
