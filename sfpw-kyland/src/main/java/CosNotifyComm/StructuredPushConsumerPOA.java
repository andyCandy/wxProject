...
public abstract class StructuredPushConsumerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.CosNotifyComm.StructuredPushConsumerOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "disconnect_structured_push_consumer", new java.lang.Integer(0));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		{
			case 0: // disconnect_structured_push_consumer
			{
