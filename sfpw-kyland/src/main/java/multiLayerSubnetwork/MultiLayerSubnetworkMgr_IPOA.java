	...
	implements org.omg.CORBA.portable.InvokeHandler, multiLayerSubnetwork.MultiLayerSubnetworkMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "deleteSNC", new java.lang.Integer(4));
		m_opsHash.put ( "getSNCsByEndObjectName", new java.lang.Integer(5));
		m_opsHash.put ( "getAllEdgePoints", new java.lang.Integer(6));
		m_opsHash.put ( "setConjunctionSNC", new java.lang.Integer(7));
		m_opsHash.put ( "getAllInternalTopologicalLinks", new java.lang.Integer(8));
		m_opsHash.put ( "deactivateSNC", new java.lang.Integer(9));
		m_opsHash.put ( "getRoutes", new java.lang.Integer(10));
		m_opsHash.put ( "getAllSubnetworkConnectionNames", new java.lang.Integer(11));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(12));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(13));
		m_opsHash.put ( "getSNC", new java.lang.Integer(14));
		m_opsHash.put ( "getAllSubnetworkConnectionsWithTP", new java.lang.Integer(15));
		m_opsHash.put ( "getAllSubnetworkConnectionNamesWithTP", new java.lang.Integer(16));
		m_opsHash.put ( "getTopologicalLink", new java.lang.Integer(17));
		m_opsHash.put ( "deactivateAndDeleteSNC", new java.lang.Integer(18));
		m_opsHash.put ( "getAllTPPoolNames", new java.lang.Integer(19));
		m_opsHash.put ( "getAllSubnetworkConnections", new java.lang.Integer(20));
		m_opsHash.put ( "getRoute", new java.lang.Integer(21));
		m_opsHash.put ( "getSNCsByNativeEmsName", new java.lang.Integer(22));
		m_opsHash.put ( "createSNC", new java.lang.Integer(23));
		m_opsHash.put ( "getTPGroupingRelationships", new java.lang.Integer(24));
		m_opsHash.put ( "getAllTopologicalLinkNames", new java.lang.Integer(25));
		m_opsHash.put ( "checkValidSNC", new java.lang.Integer(26));
		m_opsHash.put ( "setUserLabel", new java.lang.Integer(27));
		m_opsHash.put ( "activateSNC", new java.lang.Integer(28));
		m_opsHash.put ( "getSNCsByUserLabel", new java.lang.Integer(29));
		m_opsHash.put ( "modifySNC", new java.lang.Integer(30));
		m_opsHash.put ( "swapSNC", new java.lang.Integer(31));
		m_opsHash.put ( "getAllTPPools", new java.lang.Integer(32));
		m_opsHash.put ( "getAllInternalTopologicalLinkNames", new java.lang.Integer(33));
		m_opsHash.put ( "getAssociatedTP", new java.lang.Integer(34));
		m_opsHash.put ( "getAllManagedElements", new java.lang.Integer(35));
		m_opsHash.put ( "getAllTopologicalLinks", new java.lang.Integer(36));
		m_opsHash.put ( "getMultiLayerSubnetwork", new java.lang.Integer(37));
		m_opsHash.put ( "getAllEdgePointNames", new java.lang.Integer(38));
		m_opsHash.put ( "getSNCs", new java.lang.Integer(39));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // getAllInternalTopologicalLinks
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 11: // getAllSubnetworkConnectionNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 15: // getAllSubnetworkConnectionsWithTP
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 18: // deactivateAndDeleteSNC
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 20: // getAllSubnetworkConnections
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 22: // getSNCsByNativeEmsName
			{
			try
			{
			...
			case 24: // getTPGroupingRelationships
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 25: // getAllTopologicalLinkNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 33: // getAllInternalTopologicalLinkNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 36: // getAllTopologicalLinks
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 37: // getMultiLayerSubnetwork
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
