...
public class _ProtectionSubnetworkIterator_IStub
	...
	implements protection.ProtectionSubnetworkIterator_I
{
	...
	public final static java.lang.Class _opsClass = protection.ProtectionSubnetworkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, protection.ProtectionSubnetworkList_THolder PGPList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				PGPList.value = protection.ProtectionSubnetworkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
