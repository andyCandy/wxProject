...
public class _WDMProtectionGroupIterator_IStub
	...
	implements protection.WDMProtectionGroupIterator_I
{
	...
	public final static java.lang.Class _opsClass = protection.WDMProtectionGroupIterator_IOperations.class;
	...
	public boolean next_n(int how_many, protection.WDMProtectionGroupList_THolder pgpList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				pgpList.value = protection.WDMProtectionGroupList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
