...
public abstract class WDMProtectionGroupIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, protection.WDMProtectionGroupIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				protection.WDMProtectionGroupList_THolder _arg1= new protection.WDMProtectionGroupList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				protection.WDMProtectionGroupList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
