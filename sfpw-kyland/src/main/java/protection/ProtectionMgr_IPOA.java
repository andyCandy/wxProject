	...
	implements org.omg.CORBA.portable.InvokeHandler, protection.ProtectionMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "retrieveWDMSwitchData", new java.lang.Integer(3));
		m_opsHash.put ( "setUserLabel", new java.lang.Integer(4));
		m_opsHash.put ( "getAllPreemptibleTPNames", new java.lang.Integer(5));
		m_opsHash.put ( "performProtectionCommand", new java.lang.Integer(6));
		m_opsHash.put ( "retrieveSwitchData", new java.lang.Integer(7));
		m_opsHash.put ( "getAllProtectionSubnetworks", new java.lang.Integer(8));
		m_opsHash.put ( "getAllNUTTPNames", new java.lang.Integer(9));
		m_opsHash.put ( "getAllEProtectionGroups", new java.lang.Integer(10));
		m_opsHash.put ( "getEProtectionGroup", new java.lang.Integer(11));
		m_opsHash.put ( "getProtectionGroup", new java.lang.Integer(12));
		m_opsHash.put ( "getAdjacentTPs", new java.lang.Integer(13));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(14));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(15));
		m_opsHash.put ( "performWDMProtectionCommand", new java.lang.Integer(16));
		m_opsHash.put ( "retrieveESwitchData", new java.lang.Integer(17));
		m_opsHash.put ( "getAllProtectedTPNames", new java.lang.Integer(18));
		m_opsHash.put ( "getWDMProtectionGroup", new java.lang.Integer(19));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // getAllPreemptibleTPNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 8: // getAllProtectionSubnetworks
			{
			try
			{
			...
			case 10: // getAllEProtectionGroups
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 16: // performWDMProtectionCommand
			{
			try
			{
				protection.ProtectionCommand_T _arg0=protection.ProtectionCommand_THelper.read(_input);
