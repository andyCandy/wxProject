...
public class _ProtectionGroupIterator_IStub
	...
	implements protection.ProtectionGroupIterator_I
{
	...
	public final static java.lang.Class _opsClass = protection.ProtectionGroupIterator_IOperations.class;
	public boolean next_n(int how_many, protection.ProtectionGroupList_THolder pgpList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				pgpList.value = protection.ProtectionGroupList_THelper.read(_is);
				return _result;
			}
