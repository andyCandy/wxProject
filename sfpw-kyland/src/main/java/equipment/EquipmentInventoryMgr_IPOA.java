	...
	implements org.omg.CORBA.portable.InvokeHandler, equipment.EquipmentInventoryMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getAllEquipment", new java.lang.Integer(4));
		m_opsHash.put ( "getAllSupportingEquipmentNames", new java.lang.Integer(5));
		m_opsHash.put ( "getAllSupportedPTPs", new java.lang.Integer(6));
		m_opsHash.put ( "unprovisionEquipment", new java.lang.Integer(7));
		m_opsHash.put ( "getContainedEquipment", new java.lang.Integer(8));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(9));
		m_opsHash.put ( "getEquipmentStaticInfo", new java.lang.Integer(10));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(11));
		m_opsHash.put ( "getAllSupportingEquipment", new java.lang.Integer(12));
		m_opsHash.put ( "setAlarmReportingOff", new java.lang.Integer(13));
		m_opsHash.put ( "getEquipment", new java.lang.Integer(14));
		m_opsHash.put ( "setAlarmReportingOn", new java.lang.Integer(15));
		m_opsHash.put ( "getAllSupportedPTPNames", new java.lang.Integer(16));
		m_opsHash.put ( "provisionEquipment", new java.lang.Integer(17));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // getAllSupportingEquipmentNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 10: // getEquipmentStaticInfo
			{
			try
			{
			...
			case 12: // getAllSupportingEquipment
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 16: // getAllSupportedPTPNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
