...
public final class TerminationPointIterator_IHelper
{
	...
	public static terminationPoint.TerminationPointIterator_I narrow(final java.lang.Object obj)
	{
		if (obj instanceof terminationPoint.TerminationPointIterator_I)
		{
	...
	public static terminationPoint.TerminationPointIterator_I narrow(final org.omg.CORBA.Object obj)
	{
		...
		{
			if (obj._is_a("IDL:mtnm.tmforum.org/terminationPoint/TerminationPointIterator_I:1.0"))
			{
